...
class FitTheme {
  static ThemeData themeData = ThemeData(
    ...
    textSelectionTheme: TextSelectionThemeData(cursorColor: Color(0xFF2F0943)),
  ...
  static ThemeData darkThemeData = ThemeData(
    ...
    dialogTheme: DialogThemeData(backgroundColor: const Color(0xFF0E0E10)),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(FitRadius.m),
        borderSide: BorderSide(color: Color(0xFF8568c6)),
      ),
      disabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(FitRadius.m),
        borderSide: BorderSide.none,
