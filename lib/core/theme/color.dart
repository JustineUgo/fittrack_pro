...
class FitColor {
  ...
  static const MaterialColor green = MaterialColor(0xFF1fc16b, {
    10: Color(0xFF1fc16b),
    100: Color(0xFF84ebb4),
    200: Color(0xFF1fc16b),
  });
  static const MaterialColor yellow = MaterialColor(0xFFdfb400, {
    10: Color(0xFFffdb43),
    100: Color(0xFFffdb43),
    200: Color(0xFFdfb400),
  });
  static const MaterialColor red = MaterialColor(0xFFd00416, {
    10: Color(0xFFfb3748),
  ...
  static Color accent(BuildContext context) =>
      context.isDark ? Color(0xFF1A1A1D) : Color(0xFFF7F7F7);

  static Color background(BuildContext context) =>
      context.isDark ? Color(0xFF1a1a1a) : Color(0xFFFFFFFF);

  static Color greyBackground(BuildContext context) =>
      context.isDark ? Color(0xFF0E0E10) : Color(0xFFF5F5F5);

  static Color whiteColor = Color(0xFFFFFFFF);

  static Color blackColor = Color(0xFF000000);

  static Color lightPurple = Color(0xFFcec3e8);
}
